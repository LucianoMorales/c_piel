...
<!-- //////////////////////////////////////////////////////////// -->
<!-- DIV TÍTULO DE FORMULARIO -->
<!-- /////////////////////////////////////////////////////////////// -->
<div class="row justify-content-md-center">
  <div class="col col-md-auto">
    <div class="input-group mb-3">
     <span style="font-size: 10px;"><H2>Búsqueda</H5></span>
      </div>
  </div>
...
<!-- /////////////////////////////////////////////////////////////////// -->
<!-- FECHAS DE PARA BUSCAR INFORMACIÓN -->
<!-- ////////////////////////////////////////////////////////////// -->
        <div class="row justify-content-md-center">
          <div class="col col-md-auto">
            <div class="input-group mb-3">
        ...
        <div class="row justify-content-md-center">
          <div class="col col-md-auto">
            <div class="input-group mb-3">
             <span style="font-size: 10px;"><i>Seleccione las fechas para lograr búsqueda</i></span>
              </div>
          </div>
      ...
      <div class="container text-center">
        <div class="row gap-0 column-gap-3">
         ...
         <div class="col-sm-12">
          <button type="button" class="btn btn-success" id="btn_descargar">Descargar XLSX</button>
         </div>
...
<script src="../javascript/estadistica/estadistica.js"></script>

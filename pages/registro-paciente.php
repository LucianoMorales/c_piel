...
<html lang="en">
   ...
   <div class="contenedor contenedor-completo">
    ...
    <div class="container-fluid" id="menu-container">
      ...
      <div class="row d-flex justify-content-center " id="titulo">
        ...
        <div class="col-sm-6 offset-sm-5 col-md-6 offset-md-3">
  ...
  <input
        ...
        <form class="row g-3 needs-validation" novalidate>
          ...
          <div class="col-md-2">
            ...
            <div class="input-group has-validation">
              <div class="form-check form-check-inline">
                <select class="form-select" aria-label="Default select example" id="seguro" required>
          ...
          <div class="col-md-3 my-3">
            ...
            <select class="form-select" aria-label="Default select example" id="area_referencia">
                ...
                <option value="3">Clinica ANCEC</option>
                <option value="4">Sector privado</option>
                <option value="5">Libre demanda</option>
      ...
      <div class="row my-3" id="cuerpo_2">
        <div class="col-12">
          <div class="form-check">
            <label for="validationCustom01" class="form-label"
              >¿Padese de alergias?</label
            >
            <div class="form-check form-check-inline">
                <select class="form-select" aria-label="Default select example" id="alergia">
                    <option value="" disabled selected hidden>Escoga una opción</option>
                    <option value="1">Si</option>
                    <option value="2">No</option>
                  </select>
            </div>
        ...
        <div class="col-md-4">
          <label for="validationCustomUsername" class="form-label">AQT</label>
          <div class="input-group has-validation">
            <input
              type="text"
              class="form-control"
        ...
        <div class="col-10 my-3">
          <label for="validationCustomUsername" class="form-label"
            >¿Medicamentos a los que es alérgicos?</label
          >
...
"></script>
  <script src="../javascript/envio_datos/datos.js"></script>
 
    <script src="../javascript/cargar_datos_provincia.js"></script>

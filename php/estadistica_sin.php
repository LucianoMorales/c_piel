...
$query1 = "SELECT seguro, COUNT(*) AS cantidad FROM paciente INNER JOIN modulo_paciente ON paciente.id_paciente = modulo_paciente.id_paciente  WHERE modulo_paciente.modulo_c_piel='si'  GROUP BY seguro";
$result1 = $con->query($query1);

// Consulta 2: Sexo y cantidad
$query2 = "SELECT sexo, COUNT(*) AS cantidad FROM paciente INNER JOIN modulo_paciente ON paciente.id_paciente = modulo_paciente.id_paciente  WHERE modulo_paciente.modulo_c_piel='si'  GROUP BY sexo";
...
END AS rango_edad,
COUNT(*) as cantidad
FROM paciente INNER JOIN modulo_paciente ON paciente.id_paciente = modulo_paciente.id_paciente  WHERE modulo_paciente.modulo_c_piel='si'
GROUP BY rango_edad;
";
$result3 = $con->query($query3);

$query4 = "SELECT biopsia, COUNT(*) AS cantidad FROM informe_medico GROUP BY biopsia;";
...
$query6 = "SELECT provincia, COUNT(*) AS cantidad FROM paciente INNER JOIN modulo_paciente ON paciente.id_paciente = modulo_paciente.id_paciente  WHERE modulo_paciente.modulo_c_piel='si' GROUP BY provincia;";
